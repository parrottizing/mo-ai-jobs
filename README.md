...
`RSS_FEED_URL`, `RSS_MAX_ITEMS_PER_RUN`, `CLASSIFIER_DESCRIPTION_CHAR_CAP`, and `DETAIL_ENRICHMENT_HEADLESS_FALLBACK_ENABLED` are migration-forward settings for the RSS-first pipeline.
