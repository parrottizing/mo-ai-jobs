...
function buildPrompt(job: ClassifierJob, promptInput: PromptInput): string {
  return [
    ...
    "- No proven long-term professional track record in: product management, content strategy/marketing/editorial, people leadership, management consulting/customer success, product design leadership, applied ML research, or advanced data science.",
